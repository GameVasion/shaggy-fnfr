...
function love.load()
	...
	menuFreeplaySWITCH = require "states.menu.menuFreeplaySWITCH"
	menuSettings = require "states.menu.menuSettings"

	-- Load weeks
	weeks = require "states.weeks.weeks-4k"
	weeks6k = require "states.weeks.weeks-6k"
	weeks7k = require "states.weeks.weeks-7k"
	weeks9k = require "states.weeks.weeks-9k"
	...
	-- Load week data
	weekData = {
		require "weeks.shaggych1",
		require "weeks.shaggych2",
		require "weeks.shaggych3",
		require "weeks.shaggych4",
		require "weeks.shaggych5",
		require "weeks.shaggych6"
	}
