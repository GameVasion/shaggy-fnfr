...
return {
	...
	initUI = function(self)
		...
		sprites.leftArrow = love.filesystem.load("sprites/arrows/4k/left-arrow.lua")
		sprites.downArrow = love.filesystem.load("sprites/arrows/4k/down-arrow.lua")
		sprites.upArrow = love.filesystem.load("sprites/arrows/4k/up-arrow.lua")
		sprites.rightArrow = love.filesystem.load("sprites/arrows/4k/right-arrow.lua")
	...
	updateUI = function(self, dt)
		...
		if not sceneIsPlaying and not graphics.isFading() then
			if health > 100 then
				health = 100
