...
return {
	...
	initUI = function(self)
		...
		sprites.leftArrow = love.filesystem.load("sprites/arrows/6k/left-arrow.lua")
		sprites.downArrow = love.filesystem.load("sprites/arrows/6k/down-arrow.lua")
		sprites.upArrow = love.filesystem.load("sprites/arrows/6k/up-arrow.lua")
		sprites.rightArrow = love.filesystem.load("sprites/arrows/6k/right-arrow.lua")
		sprites.leftArrow2 = love.filesystem.load("sprites/arrows/6k/left-arrow2.lua")
		sprites.rightArrow2 = love.filesystem.load("sprites/arrows/6k/right-arrow2.lua")
		...
		for i = 1, 6 do
			enemyArrows[i].x = -950 + 125 * i
			boyfriendArrows[i].x = 65 + 125 * i
	...
	generateNotes = function(self, chart)
		...
		for i = 1, #chart do
			...
			for j = 1, #chart[i].sectionNotes do
				...
				if noteType == 0 or noteType == 6 then
					sprite = sprites.leftArrow
				elseif noteType == 1 or noteType == 7 then
					sprite = sprites.downArrow
				elseif noteType == 2 or noteType == 8 then
					sprite = sprites.rightArrow
				elseif noteType == 3 or noteType == 9 then
					sprite = sprites.leftArrow2
				elseif noteType == 4 or noteType == 10 then
					sprite = sprites.upArrow
				elseif noteType == 5 or noteType == 11 then
