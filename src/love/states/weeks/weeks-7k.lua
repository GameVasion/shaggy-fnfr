...
return {
	...
	initUI = function(self)
		...
		sprites.leftArrow = love.filesystem.load("sprites/arrows/7k/left-arrow.lua")
		sprites.downArrow = love.filesystem.load("sprites/arrows/7k/down-arrow.lua")
		sprites.upArrow = love.filesystem.load("sprites/arrows/7k/up-arrow.lua")
		sprites.middleArrow = love.filesystem.load("sprites/arrows/7k/middle-arrow.lua")
		sprites.rightArrow = love.filesystem.load("sprites/arrows/7k/right-arrow.lua")
		sprites.leftArrow2 = love.filesystem.load("sprites/arrows/7k/left-arrow2.lua")
		sprites.rightArrow2 = love.filesystem.load("sprites/arrows/7k/right-arrow2.lua")
		...
		for i = 1, 7 do
			enemyArrows[i].x = -960 + 125 * i
			boyfriendArrows[i].x = -30 + 125 * i
			boyfriendArrows[i].sizeX, boyfriendArrows[i].sizeY = 0.8, 0.8
			enemyArrows[i].sizeX, enemyArrows[i].sizeY = 0.8, 0.8
	...
	generateNotes = function(self, chart)
		...
		for i = 1, #chart do
			...
			for j = 1, #chart[i].sectionNotes do
				...
				if noteType == 0 or noteType == 7 then
					sprite = sprites.leftArrow
				elseif noteType == 1 or noteType == 8 then
					sprite = sprites.downArrow
				elseif noteType == 2 or noteType == 9 then
					sprite = sprites.rightArrow
				elseif noteType == 3 or noteType == 10 then
					sprite = sprites.middleArrow
				elseif noteType == 4 or noteType == 11 then
					sprite = sprites.leftArrow2
				elseif noteType == 5 or noteType == 12 then
					sprite = sprites.upArrow
				elseif noteType == 6 or noteType == 13 then
				...
				if settings.downscroll then
					if mustHitSection then
						if noteType >= 7 then
							...
							enemyNotes[id][c].sizeX, enemyNotes[id][c].sizeY = 0.8, 0.8
							...
							boyfriendNotes[id][c].sizeX, boyfriendNotes[id][c].sizeY = 0.8, 0.8
	...
	update = function(self, dt)
		...
		if countingDown or love.system.getOS() == "Web" then -- Source:tell() can't be trusted on love.js!
			...
			if not graphics.isFading() and not sceneIsPlaying then
			...
			if musicTime <= 7500 then
				if settings.downscroll then
					if input:getActiveDevice() ~= "joy" then
						love.graphics.print("S", 55, 200, nil, 3.4, 3.4)
						love.graphics.print("D", 195, 200, nil, 3.4, 3.4)
						love.graphics.print("F", 325, 200, nil, 3.4, 3.4)
						love.graphics.print("SPACE", 425, 200, nil, 1, 1)
						love.graphics.print("J", 580, 200, nil, 3.4, 3.4)
						love.graphics.print("K", 690, 200, nil, 3.4, 3.4)
						love.graphics.print("L", 820, 200, nil, 3.4, 3.4)
					else
						love.graphics.print("Left", 55, 300, nil, 0.9, 0.9)
						love.graphics.print("Down", 195, 300, nil, 0.9, 0.9)
						love.graphics.print("Right", 325, 300, nil, 0.9, 0.9)
						love.graphics.print("LB/RB/LT/RT", 420, 300, nil, 0.7, 0.7)
						love.graphics.print("Y", 580, 300, nil, 0.9, 0.9)
						love.graphics.print("X", 690, 300, nil, 0.9, 0.9)
						love.graphics.print("A", 820, 300, nil, 0.9, 0.9)
					end
				else
					if input:getActiveDevice() ~= "joy" then
						love.graphics.print("S", 55, -250, nil, 3.4, 3.4)
						love.graphics.print("D", 195, -250, nil, 3.4, 3.4)
						love.graphics.print("F", 325, -250, nil, 3.4, 3.4)
						love.graphics.print("SPACE", 425, -250, nil, 1, 1)
						love.graphics.print("J", 580, -250, nil, 3.4, 3.4)
						love.graphics.print("K", 690, -250, nil, 3.4, 3.4)
						love.graphics.print("L", 820, -250, nil, 3.4, 3.4)
					else
						love.graphics.print("Left", 55, -350, nil, 0.9, 0.9)
						love.graphics.print("Down", 195, -350, nil, 0.9, 0.9)
						love.graphics.print("Right", 325, -350, nil, 0.9, 0.9)
						love.graphics.print("LB/RB/LT/RT", 420, -350, nil, 0.7, 0.7)
						love.graphics.print("Y", 580, -350, nil, 0.9, 0.9)
						love.graphics.print("X", 690, -350, nil, 0.9, 0.9)
						love.graphics.print("A", 820, -350, nil, 0.9, 0.9)
					end
				end
			end
