...
return {
	...
	initUI = function(self)
		...
		sprites.leftArrow = love.filesystem.load("sprites/arrows/9k/left-arrow.lua")
		sprites.downArrow = love.filesystem.load("sprites/arrows/9k/down-arrow.lua")
		sprites.upArrow = love.filesystem.load("sprites/arrows/9k/up-arrow.lua")
		sprites.rightArrow = love.filesystem.load("sprites/arrows/9k/right-arrow.lua")
		sprites.middleArrow = love.filesystem.load("sprites/arrows/9k/middle-arrow.lua")
		sprites.leftArrow2 = love.filesystem.load("sprites/arrows/9k/left-arrow2.lua")
		sprites.downArrow2 = love.filesystem.load("sprites/arrows/9k/down-arrow2.lua")
		sprites.upArrow2 = love.filesystem.load("sprites/arrows/9k/up-arrow2.lua")
		sprites.rightArrow2 = love.filesystem.load("sprites/arrows/9k/right-arrow2.lua")
		...
		for i = 1, 9 do
			enemyArrows[i].x = -925 + 90 * i
			boyfriendArrows[i].x = 35 + 90 * i
			boyfriendArrows[i].sizeX, boyfriendArrows[i].sizeY = 0.75, 0.75
			enemyArrows[i].sizeX, enemyArrows[i].sizeY = 0.75, 0.75
	...
	generateNotes = function(self, chart)
		...
		for i = 1, #chart do
			...
			for j = 1, #chart[i].sectionNotes do
				...
				if noteType == 0 or noteType == 9 then
					sprite = sprites.leftArrow
				elseif noteType == 1 or noteType == 10 then
					sprite = sprites.downArrow
				elseif noteType == 2 or noteType == 11 then
					sprite = sprites.upArrow
				elseif noteType == 3 or noteType == 12 then
					sprite = sprites.rightArrow
				elseif noteType == 4 or noteType == 13 then
					sprite = sprites.middleArrow
				elseif noteType == 5 or noteType == 14 then
					sprite = sprites.leftArrow2
				elseif noteType == 6 or noteType == 15 then
					sprite = sprites.downArrow2
				elseif noteType == 7 or noteType == 16 then
					sprite = sprites.upArrow2
				elseif noteType == 8 or noteType == 17 then
